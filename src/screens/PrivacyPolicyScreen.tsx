        ...
        <View style={styles.content}>
          ...
          <View style={styles.article}>
            <Text style={styles.articleContent}>
              PushOn(이하 "회사")는 「개인정보 보호법」, 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」 등 관련 법령에 따라 이용자의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 다음과 같이 개인정보처리방침을 수립·공개합니다.
            </Text>
          </View>

          {/* 제1조 */}
          <View style={styles.article}>
            <Text style={styles.articleTitle}>제1조 (개인정보의 수집 및 이용목적)</Text>
            <Text style={styles.articleContent}>
          ...
          <View style={styles.article}>
            ...
            <Text style={styles.articleContent}>
              <Text style={styles.subTitle}>1. 회사는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체없이 파기합니다.</Text>{'\n\n'}
              <Text style={styles.subTitle}>2. 다음의 정보에 대해서는 아래의 이유로 명시한 기간 동안 보존합니다.</Text>{'\n\n'}
              • 회원 정보: 회원 탈퇴 시까지{'\n'}
              • 운동 기록: 회원 탈퇴 후 1년{'\n'}
              • 서비스 이용 기록: 3개월{'\n'}
              • 부정이용 기록: 1년{'\n\n'}
              <Text style={styles.subTitle}>3. 관련 법령에 의한 정보보유 사유</Text>{'\n'}
          ...
          {/* 제5조 */}
          <View style={styles.article}>
            <Text style={styles.articleTitle}>제5조 (개인정보의 제3자 제공)</Text>
            <Text style={styles.articleContent}>
          ...
          <View style={styles.article}>
            ...
            <Text style={styles.articleContent}>
              ...
              <Text style={styles.subTitle}>• Supabase (데이터베이스 서비스)</Text>{'\n'}
              - 위탁업무: 회원 정보 및 운동 기록 저장{'\n'}
              - 보유 및 이용기간: 회원 탈퇴 시까지{'\n\n'}
              <Text style={styles.subTitle}>• Google Analytics (분석 서비스)</Text>{'\n'}
              - 위탁업무: 서비스 이용 통계 분석{'\n'}
              - 보유 및 이용기간: 익명화된 통계 데이터
            </Text>
          </View>

          {/* 제7조 */}
          <View style={styles.article}>
            <Text style={styles.articleTitle}>제7조 (개인정보의 안전성 확보조치)</Text>
            <Text style={styles.articleContent}>
          ...
          {/* 제9조 */}
          <View style={styles.article}>
            <Text style={styles.articleTitle}>제9조 (정보주체의 권리·의무 및 행사방법)</Text>
            <Text style={styles.articleContent}>
          ...
          {/* 제10조 */}
          <View style={styles.article}>
            <Text style={styles.articleTitle}>제10조 (개인정보처리방침의 변경)</Text>
            <Text style={styles.articleContent}>
              1. 이 개인정보처리방침은 시행일로부터 적용되며, 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.{'\n\n'}
              2. 회사는 개인정보의 수집 및 활용, 제3자 제공 등 정보통신망 이용촉진 및 정보보호 등에 관한 법률 제27조의2에 따라 이용자의 동의를 받아야 하는 경우에는 미리 동의를 받습니다.
            </Text>
          </View>
          ...
          <View style={styles.contactSection}>
            ...
            <Text style={styles.contactText}>
              개인정보 처리에 관한 문의사항이 있으시면 설정 > 문의하기를 통해 연락해주세요.{'\n\n'}
