...
function TermsOfServiceScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      {/* 헤더 */}
      <Header title="이용약관" onBackPress={() => navigation.goBack()} />
        ...
        <View style={styles.content}>
          ...
          <View style={styles.article}>
            ...
            <Text style={styles.articleContent}>
              본 약관은 PushOn(이하 "회사")이 제공하는 푸쉬업 카운팅 서비스(이하
          ...
          <View style={styles.article}>
            ...
            <Text style={styles.articleContent}>
              1. "서비스"란 얼굴인식 기술을 활용한 푸쉬업 자동 카운팅, 운동 기록
              관리, 통계 분석 등의 기능을 제공하는 모바일 애플리케이션을
              의미합니다.{'\n\n'}
          ...
          <View style={styles.article}>
            ...
            <Text style={styles.articleContent}>
              ...
              3. 이용자가 변경된 약관에 동의하지 않는 경우 서비스 이용을 중단할
              수 있습니다.
            </Text>
          </View>
          ...
          <View style={styles.article}>
            ...
            <Text style={styles.articleContent}>
              ...
              3. 회사는 컴퓨터 등 정보통신설비의 보수점검, 교체 및 고장, 통신의
          ...
          <View style={styles.article}>
            ...
            <Text style={styles.articleContent}>
              1. 회사는 운영정책상 또는 기술상의 필요에 의하여 제공하고 있는
          ...
          <View style={styles.article}>
            ...
            <Text style={styles.articleContent}>
              ...
              변경시 허위내용의 등록{'\n'}• 타인의 정보 도용{'\n'}• 회사가
              게시한 정보의 변경{'\n'}• 회사가 정한 정보 이외의 정보(컴퓨터
              프로그램 등) 등의 송신 또는 게시{'\n'}• 회사 기타 제3자의 저작권
              등 지적재산권에 대한 침해{'\n'}• 회사 기타 제3자의 명예를
              손상시키거나 업무를 방해하는 행위{'\n'}• 외설 또는 폭력적인
              메시지, 화상, 음성, 기타 공서양속에 반하는 정보를 서비스에 공개
              또는 게시하는 행위{'\n\n'}
              2. 이용자는 서비스 이용과 관련하여 관련법령, 본 약관의 규정,
              이용안내 및 서비스와 관련하여 공지한 주의사항을 준수하여야 합니다.
            </Text>
          </View>
          ...
          <View style={styles.article}>
            ...
            <Text style={styles.articleContent}>
              ...
              않습니다.{'\n\n'}
              3. 회사는 이용자의 개인정보를 수집·이용하는 때에는 당해 이용자에게
              그 목적을 고지하고 동의를 받습니다.{'\n\n'}
              4. 회사는 수집된 개인정보를 목적외의 용도로 이용할 수 없으며,
          ...
          <View style={styles.article}>
            ...
            <Text style={styles.articleContent}>
              1. 회사는 법령과 본 약관이 금지하거나 공서양속에 반하는 행위를
          ...
          <View style={styles.article}>
            ...
            <Text style={styles.articleContent}>
              1. 회사가 제공하는 서비스로 인하여 이용자에게 손해가 발생한 경우
              그러한 손해가 회사의 고의나 중대한 과실에 의한 경우를 제외하고는
              회사에서 책임지지 않습니다.{'\n\n'}
              2. 회사는 이용자가 서비스를 이용하여 기대하는 수익을 상실한 것에
          ...
          <View style={styles.article}>
            ...
            <Text style={styles.articleContent}>
              1. 서비스 이용으로 발생한 분쟁에 대해 소송이 제기되는 경우 회사의
          ...
          <View style={styles.contactSection}>
            ...
            <Text style={styles.contactText}>
              본 약관에 대한 문의사항이 있으시면 설정 → 문의하기를 통해
              연락해주세요.
            </Text>
          </View>
        </View>
